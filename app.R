                      ...
                      wellPanel(
                        ...
                        conditionalPanel(
                          ...
                          tags$ol(
                            ...
                            tags$li("They plan to use a one-sided 95% confidence interval.")
                          ),
                          p("The researchers will need to enroll 26 participants for the pilot trial (13 per group) to have a one-sided 95% confidence interval with a maximum width of 20% (0% to 20%).")
                        ),
                        # Show Count example
                        conditionalPanel(
                          ...
                          tags$ol(
                            ...
                            tags$li("They plan to use a two-sided 95% confidence interval.")
                          ),
               ...
               column(6,
                      wellPanel(
                        ...
                        conditionalPanel(
                          ...
                          numericInput("side1", "Side of confidence interval", value = 2),
               ...
               column(6,
                      ...
                      wellPanel(
                        ...
                        conditionalPanel(
                          ...
                          p("Because the unit of observation is month rather than individuals, they calculate that an enrollment period of 5 months is needed for the pilot trial. This calculation is based on a one-sample exact test for Poisson rate with a one-sided type I error of 0.05 and power of 0.9. It assumes a constant recruitment rate, so researchers might choose to extend the duration of the pilot trial to allow recruitment to stabilize.")
                        )
                      )
               ),
               # Top Right - Input
