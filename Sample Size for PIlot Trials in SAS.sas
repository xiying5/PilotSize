...
sample size for pilot trials: A tutorial" in XX. For details on the methods, examples, and sample size 
tables, please refer to the paper. Unless otherwise specified, all calculations refer to the total 
number of participants that will need to be enrolled in the pilot trial.
*/
...
%let pi = 0.05;    /* Anticipated probability of the event of interest */
